...
class Diagnosis(models.Model):
    file_number = models.ForeignKey(FileNumber, on_delete=models.CASCADE, related_name='diagnoses')
...
class MedicalRecord(models.Model):
    file_number = models.ForeignKey(FileNumber, on_delete=models.CASCADE, related_name='medical_records')
...
class Symptom(models.Model):
    medical_record = models.ForeignKey(MedicalRecord, on_delete=models.CASCADE, related_name='symptoms')
